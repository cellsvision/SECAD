...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
                 ...
                 layer_scale_init_value=1e-6, head_init_scale=1., need_head=True, need_cam=False
                 ):
        super().__init__()
...
if __name__ == '__main__':
    model = convnext_base(pretrained=False, need_cam=True)
    input = torch.zeros((8, 3, 512, 512))
    output = model(input)
    print(output)
